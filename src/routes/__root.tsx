...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "صيدلية المصلي — صحتك تهمنا" },
      { property: "og:description", content: "تسوّق الأدوية والمستلزمات الطبية ومنتجات العناية بأفضل الأسعار مع توصيل سريع." },
