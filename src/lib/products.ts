...
const meds: Product[] = [
  // ===== شركة الحكمة Hikma =====
  m("سيفترياكسون 1غ حقن (Hikma)", "Hikma", 1800, 2200, "مضاد حيوي واسع الطيف للحقن الوريدي/العضلي. يُستخدم لعلاج الالتهابات البكتيرية الشديدة.", IMG.injection, "حكمة"),
  ...
  m("أوجمنتين شراب 156mg/5ml (Hikma)", "Hikma", 2200, undefined, "أموكسيسيلين + كلافولانات للأطفال — مضاد حيوي مركّب.", IMG.syrup, "حكمة"),
  ...
  m("سالبوتامول بخاخ 100mcg (Hikma)", "Hikma", 2400, 2900, "موسع للشعب الهوائية لمرضى الربو.", IMG.inhaler, "حكمة"),
  ...
  m("بيرافيرين شراب مضاد للسعال (Hikma)", "Hikma", 1100, undefined, "شراب مهدئ للسعال الجاف.", IMG.syrup, "حكمة"),
  ...
  m("ميامباستول قطرة عين 5مل", "Novartis", 3200, undefined, "قطرات لعلاج الجلوكوما (المياه الزرقاء).", IMG.drops, "نوفارتيس"),
  ...
  m("يامي-كولد شراب للسعال 100مل", "YEPCA", 650, undefined, "شراب مهدئ للسعال ونزلات البرد.", IMG.syrup, "محلي"),
  ...
  m("يامي-سال شراب فيتامينات أطفال 120مل", "YEPCA", 980, undefined, "مكمل فيتامينات للأطفال.", IMG.syrup, "محلي"),
  m("يامي-أزيث 500mg — 3 أقراص", "YEPCA", 1100, undefined, "أزيثرومايسين — مضاد حيوي.", IMG.pill, "محلي"),
  m("يامي-كاف شراب طارد للبلغم 100مل", "YEPCA", 580, undefined, "طارد للبلغم في نزلات البرد.", IMG.syrup, "محلي"),
  ...
  m("يامي-بان شراب أطفال باراسيتامول 60مل", "YEPCA", 380, undefined, "خافض حرارة للأطفال.", IMG.syrup, "محلي"),
  m("يامي-فيت B-Complex — 30 قرص", "YEPCA", 580, undefined, "مكمل فيتامينات B.", IMG.pill, "محلي"),
  m("يامي-أوغ شراب أموكسي/كلاف 156mg — 100مل", "YEPCA", 1400, undefined, "مضاد حيوي مركّب للأطفال.", IMG.syrup, "محلي"),
];
